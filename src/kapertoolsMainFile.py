#Agatex ;) Hubert Kotarski Muzeum Gdansk Copyright
...
root = Tk()
root.title("Muzeum Gdansk - Kaper Tools v.0.6 (alfa)")
...
button3 = Button(text="Proceed kaper creation", command= lambda: kcf.main(tk_path_var,v),height=10)
